...
if { [catch { 
	...
	set Addc2 [AddChannel chid 2 chpid 1 down $sec max_down $sec max_up $sec up $sec ]
	set Addc3 [AddChannel chid 3 chpid 2 down $half up $half max_down $half max_up $half]
	set Chgc2 [ChgChannel $par1]
        if {$Addc1==1&&$Addc2==1&&$Addc3==1&&$Chgc2==$exp} {
        set script_flag 1
	puts "=============OK=========="	
        } else {
		set script_flag 0
